      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="rounded-xl border bg-card p-6 shadow-sm space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="flex w-full items-center justify-center gap-3 rounded-lg border bg-background px-4 py-3 text-sm font-medium transition-colors hover:bg-accent disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {/* Google logo SVG */}
          ...
          <p className="text-center text-xs text-muted-foreground">
            By signing in you agree to adidas&apos; internal platform terms.
          </p>
        </div>
      </div>
    </div>
