...
/* ══════════════════════════════════════════════════════════════════════
   /welcome — Hero page V2 (designer refresh)

   Rebuilt from the designer PDF (heropage/HeroPageV2.pdf).
   Fonts: Adineue Pro / Adihaus DIN, adapted in size/weight/spacing.
   ══════════════════════════════════════════════════════════════════════ */
