...
The BlendEd program is an international partnership between universities and
companies across Europe in which multinational student teams design and
implement software solutions for problems sourced from a partner company's
day-to-day operations. In this edition the partner company was adidas GBS
Porto, and the teams were international: the author's team alone brought
together members from several countries --- among them Portugal, Greece,
Croatia, Belgium and Germany. The program ran four subprojects in parallel --- a talent pool,
an onboarding assistant, a community-research tool and an employer-branding
solution --- each with its own team and product owner. This report covers the
...
\gls{ats} --- requisition approval chains, offer management, payroll and
onboarding --- together with any feature that would auto-reject a candidate
...
\midrule
Structured, GDPR-aware talent pool & Full applicant-tracking workflow (requisitions, approvals) \\
Automated CV ingestion and parsing & Offer management, contracts and payroll \\
Explainable job-anchored matching & Onboarding of hired employees \\
CEFR language and technical-skill verification & Automatic rejection without human review \\
HR communication, campaigns and audit trail & Replacement of the corporate ATS (SAP SuccessFactors) \\
Recruitment analytics and custom widgets & Cross-organisation, multi-tenant operation \\
\bottomrule
\end{tabular}
\end{table}
