...
was supposed to do. Table~\ref{tab:traceability} threads each principal
...
questions of Appendix~\ref{app:survey}.}
...
Search-injection safety & \texttt{escape-or-term} & May 2026 audit \\
...
structured validation interview from the client rather than a statistical
sample. Its value lies in the detail and authority of the source: this is a
...
responses are reproduced in Appendix~\ref{app:survey}
(Table~\ref{tab:survey-responses}).
...
positioning, argued in Chapter~\ref{cap:state-of-the-art}, as a focused
...
Figure~\ref{fig:survey-classification} summarises the fourteen survey items
...
\end{axis}
\end{tikzpicture}
\caption[Survey items by validation category]{The fourteen survey items
classified by how they bear on the project (author's classification of the
Appendix~\ref{app:survey} responses). Gap-validating items: Q3, Q10--Q14;
ATS-adequate: Q2, Q6--Q9; contextual: Q1, Q4, Q5.}
