...
\newglossaryentry{blended}{
	name={BlendEd},
	description={International academic--industry partnership programme in which multinational student teams from European universities design and implement software solutions for problems sourced from a partner company. In this edition the partner company was adidas Global Business Services Porto}
}
