...
\thesistitle{Título do Relatório} % Your thesis title, this is used in the title, print it elsewhere with \ttitle

\thesisinstitution{Nome da Empresa/Organização} % Where the internship took place, this is used in the title, print it elsewhere with \tinstitution

\thesisacademicyear{20XX/20XX} % Academic year, e.g. "2024/2025"

\studentname{Nome do Estudante} % Your name, this is used in the title page, print it elsewhere with \authorname

\studentnumber{1xxxxxx} % Student number, e.g. "1209999"

\supervisor{Nome do Orientador} % Academic supervisor at ISEP

\externalsupervisor{Nome do Supervisor Externo} % External supervisor at the internship institution, if exists; comment this line if does not exist.

\examdate{Mês e ano da prova} % Exam month/year date, e.g. "Abril de 2025"
